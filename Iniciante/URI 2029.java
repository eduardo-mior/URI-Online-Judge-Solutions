...
/*
 ...
 dupla precisão com duas casas decimais após a vírgula, sendo um V (1.00 <= V 
 <= 10000.00) e outro D (1.00 <= D <= 100.00), representando respectivamente 
 o volume e o diâmetro do recipiente.
 ...
 segunda linha a mensagem "AREA = ", também com um espaço depois de AREA e 
 outro depois do símbolo de igualdade, seguido do valor da area da boca(entrada) 
 do recipiente com duas casas decimais após a vírgula.
